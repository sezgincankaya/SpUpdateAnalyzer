...
{
    /// <summary>Sunucu üzerindeki veritabanı adı.</summary>
    public string DatabaseName { get; set; } = string.Empty;

    /// <summary>SP'nin ait olduğu şema adı.</summary>
    public string SchemaName { get; set; } = string.Empty;

    /// <summary>Stored Procedure adı (DB.Schema.SP formatında).</summary>
